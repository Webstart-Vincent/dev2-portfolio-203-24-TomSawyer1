  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col justify-center">
      ...
      <div className="max-w-md w-full mx-auto">
        ...
        <h1 className="text-3xl font-bold text-center text-gray-900">Créer un nouveau projet</h1>
        <form onSubmit={handleSubmit} className="mt-8 space-y-6 bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
          ...
          <div>
            <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="description_seo">
              Description SEO
            </label>
            <input
              id="description_seo"
          ...
          <div>
            <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="title_seo">
              Titre SEO
            </label>
            <input
              id="title_seo"
